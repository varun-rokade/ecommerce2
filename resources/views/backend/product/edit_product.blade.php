                        ...
                        <div class="row"><!--Start 2nd Row-->  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="subsubcategory_id" required class="form-control">
                                            ...
                                            <option value="{{ $sscat -> id }}" {{ $sscat -> id == $product->subsubcategory_id ? 'selected' : '' }}>{{ $sscat ->subsubcategory_name_en }} </option>
                                            @endforeach
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_name_hin" class="form-control" value="{{$product->product_name_hin}}"> </div>
                        ...
                        <div class="row"><!--Start 3rd Row-->  
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_code" value="{{$product->product_code}}"  class="form-control"> </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_qty"  value="{{$product->product_qty}}" class="form-control"> </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_en" class="form-control" value="{{$product->product_tags_en}}" data-role="tagsinput"> </div>
                        ...
                        <div class="row"><!--Start 4th Row-->  
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_hin" class="form-control" value="{{$product->product_tags_hin}}" data-role="tagsinput"> </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_hin" class="form-control" value="{{$product->product_size_hin}}" data-role="tagsinput"> </div>
                        ...
                        <div class="row"><!--Start 5th Row-->  
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_en" class="form-control" value="{{$product->product_color_en}}" data-role="tagsinput"> </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_hin" class="form-control" value="{{$product->product_color_hin}}" data-role="tagsinput"> </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="selling_price" value="{{$product->selling_price}}" class="form-control" > </div>
                                </div>
                        ...
                        <div class="row"><!--Start 7th Row-->  
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_desc_en" id="textarea" value="{{$product->short_desc_en}}" class="form-control" >{!! $product-> short_desc_en!!}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_desc_hin" id="textarea" class="form-control">{!! $product-> short_desc_en!!}</textarea>
                                    </div>
                                </div>
