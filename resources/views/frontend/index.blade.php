            ...
            <div class="item" style="background-image: url({{asset($slide->image)}});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  ...
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{$slide ->desc}}</span> </div>
        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
          <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
              ...
              <li><a data-transition-type="backSlide" href="#category{{ $item->id }}" data-toggle="tab">{{ $item->category_name_en }}</a></li>
              @endforeach
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="{{ url('product/details/'.$item->id) }}"><img  src="{{asset($item->product_thumbnail)}}" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="{{ url('product/details/'.$item->id.'/'.$item->product_slug_en) }}">
                            ...
                            @if(session()->get('language') == 'hindi'){{$item->product_name_hin}} @else {{ $item->product_name_en }} @endif</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">{{ $item->selling_price}}</span> <span class="price-before-discount">{{ $item->discount_price }}</span> </div>
                          <!-- /.product-price --> 
...
@endphp --}}
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset($item->product_thumbnail)}}" alt=""></a> </div>
                          <!-- /.image -->
