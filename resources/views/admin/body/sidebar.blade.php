    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview  {{ ($prefix =='/brands') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu {{ ($route =='all.brands') ? 'active' : '' }} ">
        ...
        <li class="treeview {{ ($prefix =='/category') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu ">
            ...
            <li class=" "><a href="{{ route('all.subsubcategory') }}"><i class="ti-more"></i>All->Sub SubCategory</a></li>
          </ul>
        </li>
        ...
        <li class="treeview {{ ($prefix =='/slider') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route =='manage.slide') ? 'active' : '' }}"><a href="{{ route('manage.slider') }}"><i class="ti-more"></i>Manage Slider</a></li>
            {{-- <li class="{{ ($route =='add.product') ? 'active' : '' }}"><a href="{{ route('add.product') }}"><i class="ti-more"></i>Add Products</a></li>
            <li><a href="gallery.html"><i class="ti-more"></i>Gallery</a></li>
            <li><a href="faq.html"><i class="ti-more"></i>FAQs</a></li>
            <li><a href="timeline.html"><i class="ti-more"></i>Timeline</a></li> --}}
